...
class DebounceInput extends React.Component {
  ...
  blur() {
    this._inputElement.current.blur();
  }
  ...
  onFocus(e) {
    if (this._ignoreNextBlurEvent) {
      ...
      e.target.setSelectionRange(
        this._prevCaretPosition.start,
        this._prevCaretPosition.end
      );
      return;
    }
  ...
  getIgnoreNextBlurEvent() {
    return this._ignoreNextBlurEvent;
  }

  hasCaretSelection() {
    return this._prevCaretPosition.start !== this._prevCaretPosition.end;
  }
  hasCaretPosition() {
    return this._prevCaretPosition.start >= 0;
  }
  getCaretPosition() {
    return this._prevCaretPosition;
  }
