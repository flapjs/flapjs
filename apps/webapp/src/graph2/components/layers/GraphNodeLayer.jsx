...
import GraphNodeRenderer from 'src/graph2/renderer/GraphNodeRenderer';
import GraphNodeInputHandler from 'src/graph2/inputhandler/GraphNodeInputHandler';
...
class GraphNodeLayer extends React.Component {
  constructor(props) {
    ...
    this._graphNodeInputHandler = new GraphNodeInputHandler(
      inputController,
      graphController
    );
  }
  ...
  getGraphNodeInputHandler() {
    return this._graphNodeInputHandler;
  }
      ...
      nodes.push(
        <Renderer
          ...
          pointerEvents={
            editable &&
            inputController &&
            inputController.hasPointerEvents(node)
              ? 'all'
              : 'none'
          }
        />
