...
import StartNodeMarkerRenderer from '../../renderer/StartNodeMarkerRenderer';
import IndexedGraphStartMarkerInputHandler from '../../inputhandler/IndexedGraphStartMarkerInputHandler';
...
class IndexedGraphStartMarkerLayer extends React.Component {
  constructor(props) {
    ...
    this._startMarkerInputHandler = new IndexedGraphStartMarkerInputHandler(
      inputController,
      graphController
    );
  }
        ...
        {target && (
          <Renderer
            ...
            pointerEvents={
              editable &&
              inputController &&
              inputController.hasPointerEvents(target)
                ? 'all'
                : 'none'
            }
          />
