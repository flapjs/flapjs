...
import GraphEdgeRenderer from '../../renderer/GraphEdgeRenderer';
...
class GraphEdgeLayer extends React.Component {
  constructor(props) {
    ...
    this._graphEdgeInputHandler = new GraphEdgeInputHandler(
      inputController,
      graphController
    );
  }
  ...
  getGraphEdgeInputHandler() {
    return this._graphEdgeInputHandler;
  }
      ...
      edges.push(
        <Renderer
          ...
          pointerEvents={
            editable &&
            inputController &&
            inputController.hasPointerEvents(edge)
              ? 'all'
              : 'none'
          }
        />
