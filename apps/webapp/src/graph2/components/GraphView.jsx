...
class GraphView extends React.Component {
  ...
  getViewportComponent() {
    return this._viewportComponent.current;
  }
  getInputAdapter() {
    return this._viewportComponent.current.getInputAdapter();
  }
  getViewportAdapter() {
    return this._viewportComponent.current.getViewportAdapter();
  }
    ...
    return (
      <div
        ...
        <ViewportComponent ref={this._viewportComponent}>
          {renderGraph &&
            viewport &&
            renderGraph(this, viewport, inputController)}
        </ViewportComponent>
        {renderOverlay &&
          viewport &&
          renderOverlay(this, viewport, inputController)}
      </div>
    );
  }
}
