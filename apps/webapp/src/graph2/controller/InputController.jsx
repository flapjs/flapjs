...
class InputController {
  ...
  onPreInputEvent(pointer) {
    ...
    this.updateCurrentTarget(
      this._immediateTarget.source,
      this._immediateTarget.type
    );
    return false;
  }
  ...
  getActiveTargetSource() {
    return this._activeTarget.source;
  }
  getActiveTargetType() {
    return this._activeTarget.type;
  }
  hasActiveTarget() {
    return this._activeTarget.type !== null;
  }

  hasPointerEvents(targetSource) {
    if (this._activeTarget.source === targetSource)
      return this._activeTarget.input;
    if (this._nodeOnly) return targetSource instanceof GraphNode;
    return true;
  }

  getCurrentTargetSource() {
  ...
  hasCurrentTarget() {
    return this._target.type !== null;
  }

  getImmediateTargetSource() {
    return this._immediateTarget.source;
  }
  getImmediateTargetType() {
    return this._immediateTarget.type;
  }
  hasImmediateTarget() {
    return this._immediateTarget.type !== null;
  }

  isTrashMode() {
    return this._trashMode;
  }
  isMoveMode(inputAdapter) {
    return !(this._moveModeFirst ^ !inputAdapter.isAltInput());
  }
  isNodeEventsOnly() {
    return this._nodeOnly;
  }
  isMoveModeFirst() {
    return this._moveModeFirst;
  }

  isHandlingInput() {
    return this._handlingInput;
  }
