...
class NodeGraph {
  ...
  getNodes() {
    return Array.from(this._nodeMapping.values());
  }
  getNodeCount() {
    return this._nodeMapping.size;
  }
  getNodeClass() {
  ...
  getEdges() {
    return Array.from(this._edgeMapping.values());
  }
  getEdgeCount() {
    return this._edgeMapping.size;
  }
  getEdgeClass() {
    return this._edgeClass;
  }
}
