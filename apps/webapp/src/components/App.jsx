...
import DrawerView, { DRAWER_SIDE_RIGHT, DRAWER_SIDE_BOTTOM, DRAWER_BAR_DIRECTION_VERTICAL, DRAWER_BAR_DIRECTION_HORIZONTAL } from 'src/components/drawer/DrawerView';
...
import ToolbarButton, { TOOLBAR_CONTAINER_TOOLBAR, TOOLBAR_CONTAINER_MENU } from 'src/components/toolbar/ToolbarButton';
...
import HotKeyManager, { CTRL_KEY, SHIFT_KEY } from 'src/session/manager/hotkey/HotKeyManager';
...
import NotificationManager, { ERROR_LAYOUT_ID } from 'src/session/manager/notification/NotificationManager';
