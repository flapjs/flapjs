...
import Style from './PreviewView.module.css';
...
class PreviewView extends React.Component {
  ...
  render() {
    return (
      <div
        id={this.props.id}
        className={Style.preview_container + ' ' + this.props.className}
        style={this.props.style}>
        <div className={Style.preview_app}>
          <div className={Style.preview_toolbar}></div>
          <div className={Style.preview_workspace}>
            <div className={Style.preview_viewport}>
              <div
                className={Style.preview_node}
                style={{ left: '25%', top: '40%' }}></div>
              <div
                className={Style.preview_node}
            ...
            <div className={Style.preview_drawer}></div>
          </div>
        </div>
      </div>
    );
