...
import Style from './StackAlphabetListElement.module.css';
...
class StackAlphabetListElement extends React.Component {
  ...
  render() {
    ...
    const displaySymbol =
      inputSymbol === null ? this.props.symbol : inputSymbol;
    ...
    return (
      <div
        id={this.props.id}
        className={
          Style.element_container +
          (displaySymbol !== null && displaySymbol.length <= 0
            ? ' empty '
            : '') +
