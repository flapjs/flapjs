...
import Style from './AutoStateLabelView.module.css';
...
class AutoStateLabelView extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        id={this.props.id}
        className={Style.select_container + ' ' + this.props.className}
        style={this.props.style}>
        <label className={Style.select_label}>State Labels</label>
        <FormattedInput
          className={Style.prefix_editor}
          defaultValue={graphController
            .getGraphLabeler()
            .getDefaultNodeLabelPrefix()}
          captureOnExit="save"
        ...
        />
        <select
          className={Style.postfix_selector}
