...
import { MACHINE_ERROR_NOTIFICATION_TAG } from 'src/modules/fsa2/components/notifications/FSANotifications';
  ...
  render() {
    ...
    return (
      <PanelContainer
        ...
        />
        <PanelSwitch
          id={'testing-step-test'}
          checked={stepMode}
          onChange={this.onStepTestChange}
          title={'Step testing'}
        />
        <PanelSwitch
