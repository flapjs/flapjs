...
class TestListView extends React.Component {
  ...
  /** @override */
  componentDidMount() {
    this.props.graphController
      .getGraphChangeHandler()
      .addListener(this.onGraphChange);
  }
  ...
  componentWillUnmount() {
    this.props.graphController
      .getGraphChangeHandler()
      .removeListener(this.onGraphChange);
  }
  ...
  onTestTest(e, item, forceImmediate = false, callback = null) {
    ...
    tester.startTest(itemValue, graphController, machineController).then(
      (result) => {
