import { convertToDFA } from './ConvertFSA';
import { intersectDFA } from './IntersectFSA';
import { invertDFA } from './InvertDFA';
// import FSA from '../FSA';
...
function haveTheSameUsedAlphabet(m1, m2) {
  ...
  if (alphabet1.size != alphabet2.size) return false;
  for (const symbol of alphabet1) {
    if (!alphabet2.has(symbol)) return false;
  }
  return alphabet1;
}
