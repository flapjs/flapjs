import AbstractMachineBuilder from 'src/modules/abstract/AbstractMachineBuilder';
import FSA, { EMPTY_SYMBOL, State } from './FSA';
import FSANode from 'src/modules/fsa2/graph/element/FSANode';
import {
  SYMBOL_SEPARATOR,
  EMPTY_CHAR,
    ...
    for (const edge of graphEdges) {
      ...
      if (
        ...
        for (const symbol of edgeLabelSymbols) {
          ...
          if (!outEdges)
            outSymbols.set(transitionSymbol, (outEdges = new Array()));
          outEdges.push(edge);
