...
import Style from './AlphabetListView.module.css';

import AlphabetListElement from './AlphabetListElement';
...
class TerminalListView extends React.Component {
  ...
  onElementChange(e, element, symbol) {
    ...
    if (symbol.length > 0) {
      ...
      if (
        machineController.isSymbol(symbol) &&
        symbol !== element.props.symbol
      ) {
