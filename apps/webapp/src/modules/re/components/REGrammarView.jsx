...
import FormattedInput from 'src/graph2/components/widgets/formatter/FormattedInput';
import DebounceButton from 'src/graph2/components/widgets/formatter/DebounceButton';

import { UNION } from 'src/modules/re/machine/RE';
  ...
  componentDidUpdate() {
    ...
    if (machineExpression !== component.getValue()) {
      ...
      component
        ...
        .setCaretPosition(caret.start, caret.end, true);
    }
  }
    ...
    return (
      <div className={Style.grammar_container}>
        ...
        <FormattedInput
          ...
          onWheel={this.onWheel}></FormattedInput>
        <div className={Style.grammar_space}></div>
