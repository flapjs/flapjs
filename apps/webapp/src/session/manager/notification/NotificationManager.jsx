...
import DefaultNotificationLayout, {
  ...
  STYLE_TYPE_ERROR,
  STYLE_TYPE_SUCCESS,
} from './components/DefaultNotificationLayout';
import SequenceNotificationLayout from './components/SequenceNotificationLayout';
...
class NotificationManager {
  ...
  onSessionStart(session) {
    ...
    this.registerNotificationLayout(DEFAULT_LAYOUT_ID, (props) => (
      <DefaultNotificationLayout styleType={STYLE_TYPE_DEFAULT} {...props} />
    ));
    this.registerNotificationLayout(WARNING_LAYOUT_ID, (props) => (
      <DefaultNotificationLayout styleType={STYLE_TYPE_WARNING} {...props} />
    ));
    this.registerNotificationLayout(ERROR_LAYOUT_ID, (props) => (
      <DefaultNotificationLayout styleType={STYLE_TYPE_ERROR} {...props} />
    ));
    this.registerNotificationLayout(SUCCESS_LAYOUT_ID, (props) => (
      <DefaultNotificationLayout styleType={STYLE_TYPE_SUCCESS} {...props} />
    ));
    this.registerNotificationLayout(SEQUENCE_LAYOUT_ID, (props) => (
      <SequenceNotificationLayout {...props} />
    ));
  }
