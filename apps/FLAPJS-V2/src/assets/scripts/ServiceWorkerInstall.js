...
// __SERVICE_WORKER_ENV__ is defined in `template.html` as a global and ONLY USED HERE.
// @ts-ignore
if (__SERVICE_WORKER_ENV__ === 'production' && 'serviceWorker' in navigator)
{
    window.addEventListener('load', function() 
    {
        ...
        fetch('../CHANGELOG.md')
            ...
            .finally(() =>
            {
                // TODO: This is hard-coded to the old url :(
                navigator.serviceWorker.register('/webapp/dist/service-worker.js').then(registration =>
                {
